...
export const postdata=(obj ,setRen)=>(dispatch)=>{
    ...
    axios.post("https://tcsfullstack.onrender.com/Employ",obj).then((res)=>{
        console.log(res)
...
axios.delete(`https://tcsfullstack.onrender.com/Employ/${id}`).then((res)=>{
    console.log(res)
...
export const updatedata=(id,obj,setRen)=>(dispatch)=>{
    ...
    axios.patch(`https://tcsfullstack.onrender.com/Employ/${id}`,obj).then((res)=>{
        console.log(res)
