...
useEffect(()=>{
const url=`https://tcsfullstack.onrender.com/Employ`
...
- Salary */}
        <h1>ID: {el._id}</h1>
          <Text fontSize={"20px"} fontWeight="bold">{el.first_name } {el.last_name }</Text>
          <Text fontSize={"20px"} fontWeight="bold">{el.email}</Text>
          <Text > </Text>
          {/* <Text >{el.rating}</Text> */}
